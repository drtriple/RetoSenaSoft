<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpanel-historial.aspx.cs" Inherits="PROYECTOSENA.Views.interaz.cpanel_historial" %>
					...
					<div class="row">
						<div class="col-sm-6 mb-4 mb-xl-0">
							<div class="d-lg-flex align-items-center">
								<div>
									<h3 class="text-dark font-weight-bold mb-2">Zona de historial</h3>
                                ...
                                <div class="col-lg-12 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <h4 class="card-title">Historial de subidas</h4>
                                                        <center>
